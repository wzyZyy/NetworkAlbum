...
public class _GeneratorModel {
	...
	public static void main(String[] args) {
		// base model 说是用的包名
		String baseModelPackageName = "cn.zuel.wlyw.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getRootClassPath() + "/../../src/main/java/cn/zuel/wlyw/model/base";
		// System.out.println(PathKit.getRootClassPath());D:\eclipse-workspace-jee\BookManage\WebRoot\WEB-INF\classes
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "cn.zuel.wlyw.model";
